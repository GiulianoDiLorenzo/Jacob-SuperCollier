...
void loop() {
  ...
  accX = (xAnalog * 5.0) / 1023.0;
  accY = (yAnalog * 5.0) / 1023.0;
  accZ = (zAnalog * 5.0) / 1023.0;

  // Calculate acceleration in g
  accX = (xVoltage - zeroGVoltageX) / sensitivity;
  accY = (yVoltage - zeroGVoltageY) / sensitivity;
  accZ = (zVoltage - zeroGVoltageZ) / sensitivity;
